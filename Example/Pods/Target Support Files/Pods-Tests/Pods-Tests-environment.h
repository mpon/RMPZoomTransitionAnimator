...
#define COCOAPODS_POD_AVAILABLE_RMPZoomTransitionAnimator
#define COCOAPODS_VERSION_MAJOR_RMPZoomTransitionAnimator 1
#define COCOAPODS_VERSION_MINOR_RMPZoomTransitionAnimator 0
#define COCOAPODS_VERSION_PATCH_RMPZoomTransitionAnimator 0
